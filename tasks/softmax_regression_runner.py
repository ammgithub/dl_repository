"""
runfile('softmax_regression_runner.py', wdir='/home/admin_thinkpad/Git/dl_repository/tasks')
"""
from modules import run_handler_softmax_vec, run_handler_softmax
...
if vec_flag:
    ...
    result = run_handler_softmax.main(train_images_fname=input_file_path + 'train-images-idx3-ubyte',
                                      train_labels_fname=input_file_path + 'train-labels-idx1-ubyte',
                                      test_images_fname=input_file_path + 't10k-images-idx3-ubyte',
                                      test_labels_fname=input_file_path + 't10k-labels-idx1-ubyte')
